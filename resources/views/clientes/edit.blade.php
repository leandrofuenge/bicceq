                ...
                <div class="p-6">
                    <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="endereco" id="endereco" rows="3"
                                          class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2">{{ old('endereco', $cliente->endereco) }}</textarea>
                                @error('endereco')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('clientes.index') }}" class="bg-gray-600 text-white px-6 py-2 rounded-md hover:bg-gray-700">
                                Cancelar
                            </a>
